...
interface LinkAProps extends AnchorHTMLAttributes<HTMLAnchorElement> {
  external?: boolean;
...
const LinkA = ({
  ...
  const smoothScroll = (e: MouseEvent<HTMLAnchorElement>) => {
    ...
    const headerHeight = document.querySelector<HTMLElement>("#header")
      ?.offsetHeight;

    if (!scrollTarget || headerHeight === undefined) return;
